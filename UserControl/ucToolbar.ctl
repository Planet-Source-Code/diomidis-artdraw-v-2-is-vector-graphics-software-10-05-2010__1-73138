  ...
  Dim hIcon As Long
    ...
    If (m_uButton(Index).Enabled) Then
      ...
      Else
        ...
        ImageList_Draw m_hIL, Index - 1, hdc, X, Y, ILD_TRANSPARENT
        DrawState hdc, m_hHighlightBrush, 0, hIcon, 0, X + 1, Y + 1, m_IconSize, m_IconSize, DST_ICON Or DSS_UNION Or DSS_DISABLED
        DrawState hdc, m_hShadowBrush, 0, hIcon, 0, X, Y, m_IconSize, m_IconSize, DST_ICON Or DSS_UNION Or DSS_DISABLED
        DestroyIcon hIcon
    End If
End Sub
