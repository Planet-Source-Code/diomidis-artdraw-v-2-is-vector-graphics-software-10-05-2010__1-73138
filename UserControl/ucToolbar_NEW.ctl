  ...
  Dim hIcon As Long
    ...
    If (m_uButton(Index).Enabled) Then
      ...
      Else
        ...
        DrawState hdc, m_hHighlightBrush, 0, hIcon, 0, X + 1, Y + 1, m_IconSize, m_IconSize, DST_BITMAP Or DSS_MONO Or DSS_UNION
        DrawState hdc, m_hShadowBrush, 0, hIcon, 0, X, Y, m_IconSize, m_IconSize, DST_ICON Or DSS_MONO Or DSS_UNION
        DestroyIcon hIcon
    End If
End Sub
